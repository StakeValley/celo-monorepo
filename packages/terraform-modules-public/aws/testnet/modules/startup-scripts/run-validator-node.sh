...
docker run -d --name celo-validator $DOCKER_LOGGING_PARAMS --restart unless-stopped --stop-timeout 300 \
  -p 30303:30303 -p 30303:30303/udp -v $PWD:/root/.celo $CELO_IMAGE --verbosity 3 \
  --syncmode full --mine --etherbase $CELO_VALIDATOR_SIGNER_ADDRESS --nodiscover --nousb \ 
  --proxy.proxied --proxy.proxyenodeurlpair=enode://$PROXY_ENODE@$PROXY_INTERNAL_IP:30503\;enode://$PROXY_ENODE@$PROXY_EXTERNAL_IP:30303 \
  --unlock=$CELO_VALIDATOR_SIGNER_ADDRESS --password /root/.celo/.password \
